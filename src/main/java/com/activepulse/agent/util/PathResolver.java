...
public final class PathResolver {
    ...
    public static Path dataDir() {
        ...
        String folder = AgentMode.isTest() ? "ActivePulse-Test" : "ActivePulse";
        String linuxFolder = AgentMode.isTest() ? "activepulse-test" : "activepulse";
        ...
        if (os.contains("win")) {
            ...
            return ensure(base.resolve(folder));
        }
        if (os.contains("mac")) {
            return ensure(Paths.get(home, "Library", "Application Support", folder));
        }
        // Linux / others
        ...
        return ensure(base.resolve(linuxFolder));
    }
